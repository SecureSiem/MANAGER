    ...
    <Box>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Box>
          ...
          >
            Monitor and investigate high-severity security events (Level 12+) that require immediate attention and response.
          </Typography>
        </Box>
                  ...
                  <Grid item xs={12} md={6}>
                    {renderChart(
                      ...
                      <Bar 
                        ...
                        options={getChartOptions('Top 10 Endpoints', true)} 
                      />,
                      'Top 10 Endpoints',
                  ...
                  <Grid item xs={12} md={6}>
                    {renderChart(
                      ...
                      <Bar 
                        ...
                        options={getChartOptions('Top 10 Alert Categorization', true)} 
                      />,
                      'Top Alert Categorization',
  ...
  <DialogTitle>
    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <Typography variant="h6">
        ...
        {fullscreenChart === 'agentDistribution' && 'Top 10 Endpoints'}
        {fullscreenChart === 'ruleGroups' && 'Top Alert Categorization'}
