...
const SCA = () => {
  ...
  variant="outlined"
  size="small"
  color={getSeverityColor(params.row.rule?.level || 0)}
  sx={{
    height: '24px',
    fontWeight: 500,
  }}
        ...
        <Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
                <Box>
                    ...
                    >
                        Evaluate system configurations against security benchmarks and identify misconfigurations that could pose risks.
                    </Typography>
                </Box>
