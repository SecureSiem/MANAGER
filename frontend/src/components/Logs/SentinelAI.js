...
const AIResponseView = ({ data, onClose, onViewFullDetails, isMlResponse = false }) => {
  ...
  // full screen mode changes by raman 
        ...
        <Box>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
            ...
            <Typography variant="h4" sx={{
              ...
              {tabValue === 0 ? 'Sentinel AI' : 'Sentinel ML'}
            </Typography>
          </Box>
          <Typography
            variant="body2"
          ...
          >
            Leverage machine learning algorithms to detect anomalies, predict threats, and automate security analysis.
          </Typography>
        </Box>
