...
const WorldConnection = ({ connectionData, height = 500 }) => {
  ...
  useEffect(() => {
    ...
    chart.background.fill = "#1E90FF"; // White background
    ...
    polygonSeries.mapPolygons.template.fill = am4core.color("#F5DEB3"); // Black countries
    ...
    // Explicitly disable legend
    chart.legend = undefined;
    
    // Make sure no series creates its own legend
    outgoingFromReservedSeries.hiddenInLegend = true;
    incomingThreatSeries.hiddenInLegend = true;
    incomingNormalSeries.hiddenInLegend = true;
    externalSeries.hiddenInLegend = true;
  ...
  return (
    <Box>
      ...
      {/* Toggle Buttons - Positioned below the map */}
      <Box 
        sx={{ 
          display: 'flex', 
          gap: 2, 
      ...
      >
        <Button
          variant={visibleConnections.outgoingFromServer ? "contained" : "outlined"}
          onClick={() => toggleConnectionVisibility('outgoingFromServer')}
          sx={{
            background: visibleConnections.outgoingFromServer 
              ? 'linear-gradient(135deg, rgba(0, 255, 0, 0.9) 0%, rgba(0, 200, 0, 0.7) 100%)' 
              : 'linear-gradient(135deg, rgba(0, 255, 0, 0.1) 0%, rgba(0, 200, 0, 0.05) 100%)',
            color: '#000000',
            borderColor: '#00FF00',
            borderWidth: 2,
            fontWeight: 'bold',
            textShadow: visibleConnections.outgoingFromServer 
              ? '0 0 4px rgba(255, 255, 255, 0.8)' 
              : '0 0 4px rgba(0, 255, 0, 0.8)',
            boxShadow: visibleConnections.outgoingFromServer 
              ? '0 4px 15px rgba(0, 255, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)' 
              : '0 2px 8px rgba(0, 255, 0, 0.2)',
            transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
            '&:hover': {
              background: visibleConnections.outgoingFromServer
                ? 'linear-gradient(135deg, rgba(0, 255, 0, 1) 0%, rgba(0, 220, 0, 0.8) 100%)'
                : 'linear-gradient(135deg, rgba(0, 255, 0, 0.2) 0%, rgba(0, 200, 0, 0.1) 100%)',
              transform: 'translateY(-2px)',
              boxShadow: visibleConnections.outgoingFromServer 
                ? '0 6px 20px rgba(0, 255, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.3)' 
        ...
        <Button
          variant={visibleConnections.incomingThreat ? "contained" : "outlined"}
          onClick={() => toggleConnectionVisibility('incomingThreat')}
          sx={{
            background: visibleConnections.incomingThreat 
              ? 'linear-gradient(135deg, rgba(255, 0, 0, 0.9) 0%, rgba(200, 0, 0, 0.7) 100%)' 
              : 'linear-gradient(135deg, rgba(255, 0, 0, 0.1) 0%, rgba(200, 0, 0, 0.05) 100%)',
            color: '#FFFFFF',
            borderColor: '#FF0000',
            borderWidth: 2,
            fontWeight: 'bold',
            textShadow: visibleConnections.incomingThreat 
              ? '0 0 4px rgba(0, 0, 0, 0.8)' 
              : '0 0 4px rgba(255, 0, 0, 0.8)',
            boxShadow: visibleConnections.incomingThreat 
              ? '0 4px 15px rgba(255, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)' 
              : '0 2px 8px rgba(255, 0, 0, 0.2)',
            transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
            '&:hover': {
              background: visibleConnections.incomingThreat
                ? 'linear-gradient(135deg, rgba(255, 0, 0, 1) 0%, rgba(220, 0, 0, 0.8) 100%)'
                : 'linear-gradient(135deg, rgba(255, 0, 0, 0.2) 0%, rgba(200, 0, 0, 0.1) 100%)',
              transform: 'translateY(-2px)',
              boxShadow: visibleConnections.incomingThreat 
                ? '0 6px 20px rgba(255, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.3)' 
        ...
        <Button
          variant={visibleConnections.incomingNormal ? "contained" : "outlined"}
          onClick={() => toggleConnectionVisibility('incomingNormal')}
          sx={{
            background: visibleConnections.incomingNormal 
              ? 'linear-gradient(135deg, rgba(0, 0, 255, 0.9) 0%, rgba(0, 0, 200, 0.7) 100%)' 
              : 'linear-gradient(135deg, rgba(0, 0, 255, 0.1) 0%, rgba(0, 0, 200, 0.05) 100%)',
            color: '#FFFFFF',
            borderColor: '#0000FF',
            borderWidth: 2,
            fontWeight: 'bold',
            textShadow: visibleConnections.incomingNormal 
              ? '0 0 4px rgba(0, 0, 0, 0.8)' 
              : '0 0 4px rgba(0, 0, 255, 0.8)',
            boxShadow: visibleConnections.incomingNormal 
              ? '0 4px 15px rgba(0, 0, 255, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)' 
              : '0 2px 8px rgba(0, 0, 255, 0.2)',
            transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
            '&:hover': {
              background: visibleConnections.incomingNormal
                ? 'linear-gradient(135deg, rgba(0, 0, 255, 1) 0%, rgba(0, 0, 220, 0.8) 100%)'
                : 'linear-gradient(135deg, rgba(0, 0, 255, 0.2) 0%, rgba(0, 0, 200, 0.1) 100%)',
              transform: 'translateY(-2px)',
              boxShadow: visibleConnections.incomingNormal 
                ? '0 6px 20px rgba(0, 0, 255, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.3)' 
                : '0 4px 12px rgba(0, 0, 255, 0.3)',
            }
          }}
        >
          Normal Incoming
        ...
        <Button
          variant={visibleConnections.external ? "contained" : "outlined"}
          onClick={() => toggleConnectionVisibility('external')}
          sx={{
            background: visibleConnections.external 
              ? 'linear-gradient(135deg, rgba(255, 255, 0, 0.9) 0%, rgba(200, 200, 0, 0.7) 100%)' 
              : 'linear-gradient(135deg, rgba(255, 255, 0, 0.1) 0%, rgba(200, 200, 0, 0.05) 100%)',
            color: '#000000',
            borderColor: '#FFFF00',
            borderWidth: 2,
            fontWeight: 'bold',
            textShadow: visibleConnections.external 
              ? '0 0 4px rgba(255, 255, 255, 0.8)' 
              : '0 0 4px rgba(255, 255, 0, 0.8)',
            boxShadow: visibleConnections.external 
              ? '0 4px 15px rgba(255, 255, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)' 
              : '0 2px 8px rgba(255, 255, 0, 0.2)',
            transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
            '&:hover': {
              background: visibleConnections.external
                ? 'linear-gradient(135deg, rgba(255, 255, 0, 1) 0%, rgba(220, 220, 0, 0.8) 100%)'
                : 'linear-gradient(135deg, rgba(255, 255, 0, 0.2) 0%, rgba(200, 200, 0, 0.1) 100%)',
              transform: 'translateY(-2px)',
              boxShadow: visibleConnections.external 
                ? '0 6px 20px rgba(255, 255, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.3)' 
                : '0 4px 12px rgba(255, 255, 0, 0.3)',
            }
          }}
        >
          External Connection
