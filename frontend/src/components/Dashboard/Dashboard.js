...
// the word and text with title or text has been changed from Agents to Endpoint 
// and the rule level distribution changed to Alert
...
const Dashboard = () => {
  ...
  try {
    ...
    setWazuhError(null);
    await fetchWazuhData();
  } catch (error) {
    setWazuhError('Failed to refresh data');
...
useEffect(() => {
  ...
  return () => clearInterval(intervalId); // clean up on unmount or timeRange change
  ...
  const getWazuhAgentStatusChartOption = () => {
    ...
    return {
      title: {
        text: 'Cybersentinel Endpoints Status',
        left: 'center',
        textStyle: {
          color: theme.palette.mode === 'dark' ? '#fff' : '#333',
          fontFamily: theme.typography.fontFamily,
  ...
  const getWazuhOSChartOption = () => {
    ...
    return {
      title: {
        text: 'Endpoints by Operating System',
        left: 'center',
        textStyle: {
          color: theme.palette.mode === 'dark' ? '#fff' : '#333',
          fontFamily: theme.typography.fontFamily,
  ...
  const getDailyLogsChartOption = () => {
    ...
    return {
      title: {
        text: 'Daily Log Trends (3-hour intervals)',
        left: 'center',
        textStyle: {
          color: theme.palette.mode === 'dark' ? '#fff' : '#333',
          fontFamily: theme.typography.fontFamily,
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Box>
          ...
          <Typography
            ...
            sx={{ maxWidth: '600px' }}
          >
            Get a comprehensive overview of your security posture with real-time metrics, threat maps, and endpoint status across your infrastructure.
          </Typography>
        </Box>
        <TimeRangeSelector
          value={timeRange}
  ...
  backgroundImage: `
    ...
    radial-gradient(at 0% 64%, hsla(357, 100%, 50%, 0.52) 0px, transparent 85%),
    radial-gradient(at 41% 94%, hsla(10, 90%, 55%, 0.85) 0px, transparent 85%),
    radial-gradient(at 100% 99%, hsla(5, 90%, 60%, 0.85) 0px, transparent 85%)
  `,
  ...
  transition: 'transform 0.3s ease, box-shadow 0.3s ease',
              '&::before': {
                ...
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(to right, transparent, rgba(252, 202, 155, 0.57), transparent)',
                transform: 'translateX(-100%) skewX(-12deg)',
                transition: 'transform 1s ease-out',
                zIndex: 1,
              },
              ...
              '&:hover': {
                transform: 'scale(1.02)',
                boxShadow: '0 16px 40px rgba(246, 136, 92, 0.4)',
              },
            }}
    ...
    radial-gradient(at 0% 64%, hsla(130, 70%, 60%, 0.52) 0px, transparent 85%),  /* Mint green */
    radial-gradient(at 41% 94%, hsla(112, 90%, 55%, 0.85) 0px, transparent 85%), /* Lime green */
    radial-gradient(at 100% 99%, hsla(100, 85%, 50%, 0.85) 0px, transparent 85%) /* Soft lime */
  `,
              ...
              '&::before': {
                ...
                position: 'absolute',
                inset: 0,
                background: 'linear-gradient(to right, transparent, rgba(196, 250, 210, 0.46), transparent)',
                transform: 'translateX(-100%) skewX(-12deg)',
                transition: 'transform 1s ease-out',
                zIndex: 1,
              },
              ...
              '&:hover': {
                transform: 'scale(1.02)',
                boxShadow: '0 16px 40px rgba(92, 246, 118, 0.4)',
              },
            }}
          ...
          <Paper sx={{
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
              ...
              <Tooltip title="View Fullscreen">
                <IconButton
                  size="small"
                  onClick={() => openFullscreen(getRuleLevelChartOption(), 'Alert Level Distribution')}
          ...
          <Paper sx={{
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
              ...
              <Tooltip title="View Fullscreen">
                <IconButton
                  size="small"
                  onClick={() => openFullscreen(getDailyLogsChartOption(), 'Daily Log Trends')}
                  className="fullscreen-icon"
                  sx={{
                    bgcolor: theme.palette.background.paper,
                    boxShadow: 1,
      ...
      <Box sx={{ mt: 4 }}>
        <Typography variant="h5" gutterBottom sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
          ...
          Cybersentinel Endpoint Management
        </Typography>
          ...
          <Grid item xs={12} md={3}>
            <Card
              ...
              sx={{
                ...
                backgroundImage: `
          radial-gradient(at 88% 40%, hsla(270, 100%, 40%, 1.00) 0px, transparent 85%),
          radial-gradient(at 49% 30%, hsla(313, 94%, 58%, 0.85) 0px, transparent 85%),
          radial-gradient(at 14% 26%, hsla(316, 100%, 66%, 1.00) 0px, transparent 85%),
          radial-gradient(at 0% 64%, hsla(288, 90%, 55%, 0.52) 0px, transparent 85%),
          radial-gradient(at 41% 94%, hsla(277, 100%, 65%, 0.75) 0px, transparent 85%),
          radial-gradient(at 100% 99%, hsla(303, 95%, 65%, 0.89) 0px, transparent 85%)
        `,
                boxShadow: '0px -16px 24px 0px rgba(203, 90, 234, 0.4) inset',
                transition: 'transform 0.3s ease, box-shadow 0.3s ease',
                '&:hover': {
                  transform: 'scale(1.02)',
                  boxShadow: '0 12px 28px rgba(224, 121, 255, 0.3)'
                }
              }}
            >
              <CardContent sx={{ p: 3 }}>
          ...
          <Grid item xs={12} md={3}>
            <Card
              ...
              sx={{
                ...
                backgroundColor: 'hsl(240, 15%, 9%)',
                backgroundImage: `
          radial-gradient(at 88% 40%, hsla(123, 100%, 33%, 1.00) 0px, transparent 85%),
          radial-gradient(at 49% 30%, hsla(135, 78%, 45%, 0.81) 0px, transparent 85%),
          radial-gradient(at 14% 26%, hsla(130, 67%, 48%, 1.00) 0px, transparent 85%),
          radial-gradient(at 0% 64%, hsla(149, 80%, 50%, 0.52) 0px, transparent 85%),
          radial-gradient(at 41% 94%, hsla(115, 90%, 50%, 0.81) 0px, transparent 85%),
          radial-gradient(at 100% 99%, hsla(141, 85%, 55%, 0.89) 0px, transparent 85%)
        `,
                boxShadow: '0px -16px 24px 0px rgba(76, 175, 80, 0.45) inset',
                transition: 'transform 0.3s ease, box-shadow 0.3s ease',
                '&:hover': {
                  transform: 'scale(1.02)',
                  boxShadow: '0 12px 28px rgba(102, 255, 102, 0.3)'
                }
              }}
            >
              <CardContent sx={{ p: 3 }}>
          ...
          <Grid item xs={12} md={3}>
            <Card
              ...
              sx={{
                ...
                backgroundColor: 'hsl(240, 15%, 9%)',
                backgroundImage: `
          radial-gradient(at 88% 40%, hsla(28, 85%, 45%, 1.00) 0px, transparent 85%),
          radial-gradient(at 49% 30%, hsla(34, 100%, 67%, 0.85) 0px, transparent 85%),
          radial-gradient(at 14% 26%, hsla(39, 100%, 50%, 1.00) 0px, transparent 85%),
          radial-gradient(at 0% 64%, hsla(45, 100%, 60%, 0.52) 0px, transparent 85%),
          radial-gradient(at 41% 94%, hsla(22, 90%, 60%, 0.85) 0px, transparent 85%),
          radial-gradient(at 100% 99%, hsla(10, 85%, 65%, 0.85) 0px, transparent 85%)
        `,
                boxShadow: '0px -16px 24px 0px rgba(255, 174, 63, 0.45) inset',
                transition: 'transform 0.3s ease, box-shadow 0.3s ease',
                '&:hover': {
                  transform: 'scale(1.02)',
                  boxShadow: '0 12px 28px rgba(255, 194, 102, 0.3)'
                }
              }}
            >
              <CardContent sx={{ p: 3 }}>
          ...
          <Grid item xs={12} md={3}>
            <Card
              ...
              sx={{
                ...
                backgroundImage: `
          radial-gradient(at 88% 40%, hsla(15, 90%, 35%, 1.00) 0px, transparent 85%),
          radial-gradient(at 49% 30%, hsla(22, 98%, 64%, 0.85) 0px, transparent 85%),
          radial-gradient(at 14% 26%, hsla(18, 98%, 55%, 1.00) 0px, transparent 85%),
          radial-gradient(at 0% 64%, hsla(34, 100%, 70%, 0.52) 0px, transparent 85%),
          radial-gradient(at 41% 94%, hsla(10, 90%, 55%, 0.85) 0px, transparent 85%),
          radial-gradient(at 100% 99%, hsla(5, 90%, 60%, 0.85) 0px, transparent 85%)
        `,
                boxShadow: '0px -16px 24px 0px rgba(254, 133, 77, 0.47) inset',
                transition: 'transform 0.3s ease, box-shadow 0.3s ease',
                '&:hover': {
                  transform: 'scale(1.02)',
                  boxShadow: '0 12px 28px rgba(246, 151, 92, 0.3)'
                }
              }}
            >
              <CardContent sx={{ p: 3 }}>
              ...
              <Paper sx={{
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
                  ...
                  <Tooltip title="View Fullscreen">
                    <IconButton
                      size="small"
                      onClick={() => openFullscreen(getWazuhAgentStatusChartOption(), 'Endpoint Distribution Status')}
                      className="fullscreen-icon"
                      sx={{
                        bgcolor: theme.palette.background.paper,
                        boxShadow: 1,
  ...
  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
    <Typography variant="h6" gutterBottom sx={{ display: 'flex', alignItems: 'center', mb: 0 }}>
      <ComputerIcon sx={{ mr: 1 }} />
      Connected Endpoint List
    </Typography>
    <IconButton aria-label="refresh" size="small" color="primary" onClick={handleRefresh}>
      <RefreshIcon />
    </IconButton>
  </Box>
