...
const MitreAttack = () => {
 ...
 const renderMitreDetails = (params) => {
   ...
   return (
    <Box sx={{ display: 'flex', gap: 0.5, maxWidth: 300, flexWrap: 'wrap' }}>
  {mitreData.id && mitreData.id.map((id, idx) => (
    <Chip
      ...
      sx={{
        color: '#d32f2f',
        fontWeight: 500,
        boxShadow: '0 0 5px rgba(211,47,47,0.7)',
  ...
  {mitreData.tactic && mitreData.tactic.map((tactic, idx) => (
    <Chip
      ...
      sx={{
        color: '#1976d2',
        fontWeight: 500,
        boxShadow: '0 0 5px rgba(25,118,210,0.7)',
  ...
  {mitreData.technique && mitreData.technique.map((technique, idx) => (
    <Chip
      ...
      sx={{
        color: '#2e7d32',
        fontWeight: 500,
        boxShadow: '0 0 5px rgba(46,125,50,0.7)',
...
const columns = [
  // Timestamp column with formatting
  {
    field: '@timestamp',
  ...
  // Severity column showing chip with label and color
  {
    field: 'rule.level',
    headerName: 'Severity',
    flex: 0.7,
  ...
  // Description column with ellipsis and tooltip
  {
  ...
  // MITRE Details column showing the custom renderMitreDetails component
  {
    field: 'mitre',
