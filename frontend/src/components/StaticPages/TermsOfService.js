    ...
    <Box sx={{ overflow: 'hidden' }}>
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            {/* All sections with icons and styled cards */}
            {[
              {
                title: "1. Acceptance of Terms",
                content: "By accessing or using the Virtual Security Operations Center (VSOC) services provided by our company, you agree to be bound by these Terms of Service (Terms). If you do not agree to these Terms, please do not use our services.",
              ...
              },
              {
                ...
                content: "While our services assist with compliance monitoring, the ultimate responsibility for compliance with industry regulations and standards (PCI-DSS, HIPAA, CERT-IN, etc.) remains with you. Our services are tools to help you meet these requirements but do not guarantee compliance.",
                icon: <SecurityIcon fontSize="large" />,
                color: "#00bcd4"
              },
              {
              ...
              },
              {
                ...
                content: "You agree to indemnify, defend, and hold harmless our company and its officers, directors, employees, and agents from and against any claims, liabilities, damages, losses, and expenses, including reasonable attorneys' fees and costs, arising out of or in any way connected with your access to or use of our services.",
                icon: <SecurityIcon fontSize="large" />,
                color: "#607d8b"
              },
              {
                title: "10. Term and Termination",
                content: "These Terms will remain in effect until terminated by either you or us. We may terminate or suspend your access to our services immediately, without prior notice or liability, for any reason, including if you breach these Terms. Upon termination, your right to use our services will immediately cease.",
                icon: <DescriptionIcon fontSize="large" />,
                color: "#3f51b5"
              },
              {
                title: "11. Changes to These Terms",
                content: "We reserve the right to modify these Terms at any time. If we make material changes to these Terms, we will provide notice through our services or by other means. Your continued use of our services after such notice constitutes your acceptance of the modified Terms.",
                icon: <ArticleIcon fontSize="large" />,
                color: "#009688"
              },
              {
              ...
              {
                title: "13. Contact Us",
                content: "If you have any questions about these Terms, please contact us through the contact information provided on our website.",
                icon: <PrivacyTipIcon fontSize="large" />,
                color: "#673ab7"
              }
            ].map((section, index) => (
            ...
            <motion.div variants={fadeInUp} custom={13}>
              <Box
                sx={{
                  mt: 6,
                  p: 4,
